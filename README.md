...
Automatically copys the token into your computer's copy buffer (Linux xclip)
...
On Linux, this will be copied directly into the paste buffer. Just press "Command-V" to paste into a login dialog.
